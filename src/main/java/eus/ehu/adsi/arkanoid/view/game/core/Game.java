...
public class Game {
	...
	public static void testCollision(Brick mBrick, Ball mBall, ScoreBoard scoreboard, int nivel, Arkanoid a, JSONObject pr) {
		...
		if (mBrick.getSuerte()) {
			JSONObject j = null;
			if (pr == null) j = ArkanoidFrontera.getArkanoidFrontera().darVentaja("null"); //TO DO: Gestión de usuarios
			else j = pr;
