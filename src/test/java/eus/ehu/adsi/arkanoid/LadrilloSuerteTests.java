...
public class LadrilloSuerteTests {
	...
	public void F4P2() {
		...
		Game.testCollision(b, bola, sc, nivel, a, null);
		assertEquals(b.destroyed, true);
		Game.testCollision(b2, bola, sc, nivel, a, null);
	...
	public void F4P2_1() {
		...
		Game.testCollision(b2, bola, sc, nivel, a, null);
		assertEquals(b2.destroyed, false);
		Game.testCollision(b3, bola, sc, nivel, a, null);
		assertEquals(b.destroyed, true);
	}
	...
	public void F4P2_2() {
		...
		Game.testCollision(bS, bola, sc, nivel, a, j);
